    ...
    <>
      ...
      <div className="shell py-24 md:py-32">
        ...
        <p className="body-text mt-6 max-w-2xl text-bone-400">
          ...
          work is early-stage; the thinking behind it is not.
        </p>
          ...
          <div className="space-y-px">
            ...
            >
              ...
              <span className="display-italic ml-3 text-lg">
                Neurodivergent-first maximalist design
              </span>
              <p className="tag mt-3">HTML/CSS · Three.js · Accessibility · Cognitive presets</p>
            </Link>
          </div>
        </div>
