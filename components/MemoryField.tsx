  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      edges.forEach((e) => {
        ...
        if (a < 0.04) return;
        ctx!.strokeStyle = `rgba(141, 217, 87, ${a * 0.22})`;
        ctx!.lineWidth = 0.6;
        ctx!.beginPath();
      ...
      nodes.forEach((n) => {
        ...
        ctx!.fillStyle =
          n.a > 0.12
            ? `rgba(141, 217, 87, ${glow * 0.85})`
            : `rgba(165, 184, 170, ${glow * 0.5})`;
        ctx!.beginPath();
    ...
    if (reduceMotion) {
      ...
      nodes.forEach((n) => {
        ctx.fillStyle = n.a > 0.12 ? `rgba(141,217,87,${n.a * 0.85})` : `rgba(165,184,170,0.06)`;
        ctx.beginPath();
        ctx.arc(n.x, n.y, n.r + n.a * 1.4, 0, Math.PI * 2);
        ctx.fill();
      });
